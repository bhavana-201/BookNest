...
<div className="section-wrapper">
  <section className="container hero-section section-content">
    <div className="hero-content">
      <h1 className="tagline">Your next great read is waiting.</h1>
...
<div className="section-wrapper">
  <section className="how-it-works-section section-content">
    <div className="container">
...
{/* CTA Section */}
<div className="section-wrapper">
  <section className="cta-banner section-content">
    <div className="container">
